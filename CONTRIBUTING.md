# Contributing to react-square-web-payments-sdk

First and foremost, thank you! We appreciate that you want to contribute to react-square-web-payments-sdk, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for react-square-web-payments-sdk**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for react-square-web-payments-sdk:

- star the [project](https://github.com/weareseeed/react-square-web-payments-sdk)
- tweet your support for react-square-web-payments-sdk
...
- **version**: (required) please note the version of react-square-web-payments-sdk are you using
...
The original poster or the maintainers of react-square-web-payments-sdk may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/react-square-web-payments-sdk
